 ...
 */
@Stateless
public class LRCasesStateless implements PredictionModelStatelessLocal {

	private String modelPath = "LinearRegression\\Linear_Resolved_Cases.model";
	Classifier cls;
    /**
     * Default constructor. 
     */
    public LRCasesStateless() {
