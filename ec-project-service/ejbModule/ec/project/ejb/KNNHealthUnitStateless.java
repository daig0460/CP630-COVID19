 ...
 */
@Stateless
public class KNNHealthUnitStateless implements PredictionModelStatelessLocal {

	private String modelPath = "KNN\\K_Nearest_Neighbor_PHU.model";
	Classifier cls;
    /**
     * Default constructor. 
     */
    public KNNHealthUnitStateless() {
