...
<title>KNN Prediction For [Blank]</title>
	...
	<body>
		<div class="colourPreference">	
			...
			<div>
				<h2 class="jumbotron rounded center shadow p-3 mt-2 mb-3 bg-white text-center">K-Nearest Neighbor: [Single Dose Percentage Prediction OR Fully Vaccinated Population Prediction]</h2>
			</div>
			
			<form method="get" action="/[ejb-project]/[servlet]">
